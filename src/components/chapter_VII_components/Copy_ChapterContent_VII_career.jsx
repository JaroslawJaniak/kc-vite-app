...
export const ChapterContent_VII_career = () => {
  ...
  const renderCareerDiceButtonComponent = (resolveDiceRoll, index) => {
    return (
      <>
        <DiceButtonComponent
          n={1}
  ...
  const renderCareerStatsModifierDiceButtonComponent = (index, career) => {
    return (
      <>
        {career[i]?.statsModifierKey}
        {career[i]?.statsModifierKey ? (
          <DiceButtonComponent
            n={career[i]?.n}
            k={career[i]?.k}
            isPremium={career[i]?.isPremium}
            diceRollResult={
          ...
          {Array.from({ length: careerNumber }, (_, i) => (
            <li key={i}>
              ...
              <>
                ...
                {context.career[i]?.statsModifierKey ? (
                  <>
                    <span>{context.career[i]?.statsModifierKey}</span>{" "}
                    <DiceButtonComponent
              ...
              <span>{"<(wynik jęsli na innej liscie)>"}</span>
              <>
