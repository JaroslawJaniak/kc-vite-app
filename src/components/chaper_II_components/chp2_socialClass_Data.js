export const dataSocialClass = (k100buttonResult) => {
  ...
  if (k100buttonResult >= 1 && k100buttonResult < 6) {
    ...
    socialClass.socialClassCastDescription = "MIESZCZAŃSTWO (ma prawo używać tytułu EL przed imieniem)";
    ...
    socialClass.socialClassCastDescription = "SZLACHTA (może używać tytułu TAN przed imieniem; tylko członkowie tej klasy społecznej mogą zostać rycerzami)";
